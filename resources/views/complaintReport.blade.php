  ...
  <body >
    ...
    <div class="container-fuild">
      <div class="container-date" style="margin-top: 25px; margin-bottom: 25px">  
        <form action="/complaint-report" method="get">
          ...
          <h2 class="fs-title" style="width: 376px; font-size: 20px; float: right; line-height: 92px">Şikayət statistikası(seçilən tarix üzrə)</h2> 
      ...
      <table class="table">
        <thead class="thead-dark">
          <tr>
            ...
            <th scope="col"> Şikayət sayı </th> 
            <th scope="col"> Əsaslı </th> 
            <th scope="col"> Əsassız </th>  
            <th scope="col"> Baxılmamış </th>  
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $item["operator"] }}</td> 
            <td>{{ $item["commonComplaints"] }}</td> 
            <td>{{ $item["reasonable"] }}</td> 
            <td>{{ $item["unreasonable"] }}</td> 
            <td>{{ $item["notResponse"] }}</td> 
          </tr>
          @endforeach
        </tbody>
      </table>
