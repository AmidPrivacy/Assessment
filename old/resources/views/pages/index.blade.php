...
@section('content') 
      <section class="section section__menu"> 
                ...
                <tr>
                  ...
                  <td>
                    @if(Auth::user() && Auth::user()->role == 0 && ($item->is_active === null || $item->is_active > 0))
                      <button class="button button--add child1" data-id="{{ $item->id }}">Qiymətləndir</button>  
                    @endif
                  </td>
                </tr>
                @endforeach  
        ...
        <div class="step-container-services"> 
          ...
          <div class="clearfix"></div>
          <input type="text" name="gplus" id="checked-count" value="25" placeholder="Say daxil edin"/>  
              ...
              <div class="col-md-6 critery-list">
                ...
                <ul class="list-group">
                  @foreach ($data['criterias'] as $dataCount => $item)
                    <li class="list-group-item d-flex justify-content-between align-items-center" data-score="{{ $item->maxScore }}" data-id="{{ $item->id }}">
