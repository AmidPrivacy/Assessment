...
Route::get('/reset-assessment/{id}', 'MainController@resetAssessment');
Route::get('/complete-assessment/{id}', 'MainController@completeAssessment');
Route::get('/complete-month', 'HomeController@completeMonth');
...
Route::get('/user-status/{type}/{id}', 'HomeController@userStatus');